...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	courses, err := r.CourseDB.FindAll(obj.ID)
...
// FindCourseByID is the resolver for the findCourseById field.
func (r *queryResolver) FindCourseByID(ctx context.Context, courseID string) (*model.Course, error) {
	course, err := r.CourseDB.FindById(courseID)
